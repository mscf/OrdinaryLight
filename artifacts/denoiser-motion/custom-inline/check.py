...
cfg=replace(_gi_config(SimpleNamespace(renderer={},id='glass-detail'),capture=True),wavefront_execution_strategy='hybrid' if os.environ.get('INLINE')=='1' else 'wavefront',wavefront_timestamps=False,denoiser_signal_capture=True,denoiser_transmission_motion_cap=True,wavefront_tile_capacity=320*240)
