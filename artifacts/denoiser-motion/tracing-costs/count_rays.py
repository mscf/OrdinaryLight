...
try:
 ...
 with ol.VulkanGlfwPresenter(w,config=cfg) as p:
  for i in range(8):p.present_wavefront(scene,pose(scene,glass,bars,os.environ.get('SUBJECT','glass'),-.3),640,480)
  results={}; frames=[]
