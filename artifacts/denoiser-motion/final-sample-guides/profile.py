...
if os.environ.get('OLD_GUIDES') == '1':
 original_files=vc.files
 class Resources:
  def __init__(self,package):self.base=original_files(package)
  def joinpath(self,name):
   if name=='shaders/denoiser_relax_prepare.comp.spv':return Path(__file__).with_name('baseline-prepare.spv')
