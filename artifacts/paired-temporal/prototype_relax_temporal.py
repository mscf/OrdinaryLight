        ...
        with runtime.lock:
            ...
            try:
                ...
                source = (
                    ...
                    .joinpath("denoiser_relax_temporal_pair.comp.spv")
                    .read_bytes()
                )
                lobe, radiance = 0, diffuse
                ...
                bindings.update({
                    15: VulkanResource.image(specular),
                    16: VulkanResource.image(previous.images[1]),
                    17: VulkanResource.image(previous.images[3]),
                    18: VulkanResource.image(output.images[1]),
                    19: VulkanResource.image(output.images[3]),
                })
