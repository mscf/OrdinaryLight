"""Portable CPU backend implementing the high-level renderer contract."""
...
class ReferenceBackend:
    """Deterministic CPU backend for portability and correctness checks."""
    ...
    def render_wavefront(
        ...
        if self._closed:
            raise RuntimeError("reference backend is closed")
